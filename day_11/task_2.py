...
for g1, g2 in combinations(galaxies, 2):
    ...
    empty_cols_count = sum(1 for col in empty_cols if x_coords[0] < col < x_coords[1])
    empty_rows_count = sum(1 for row in empty_rows if y_coords[0] < row < y_coords[1])
...
print(f"Sum of all distances is: {dist_sum}")
